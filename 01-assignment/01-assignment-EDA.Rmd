...
p1 <- ggplot(data = filter(df_all, year == "2004")) +
  geom_jitter(mapping = aes(x = Date, y = PM2.5Concentration), col = "red") +
  geom_smooth(mapping = aes(x = Date, y = PM2.5Concentration), col = "black")

p2 <- ggplot(data = filter(df_all, year == "2019")) +
  geom_jitter(mapping = aes(x = Date, y = PM2.5Concentration), col = "blue") +
  geom_smooth(mapping = aes(x = Date, y = PM2.5Concentration), col = "black") +
  ylim(0, 250)
...
```{r Histograms of PM 2.5 concentrations}
