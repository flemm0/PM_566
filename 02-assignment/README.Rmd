...
```
\
The stat summary above reveals that when looking at fev by smoke and gas exposure, there the median fev for the groups all lie at 2000. The groups having no exposure to smoke or gas, as well as the group exposed to smoke only have medians slightly higher than the other two groups. Additionally, the range of observations for the groups exposed to neither and gas are greater than for the other two groups.
