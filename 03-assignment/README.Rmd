...
Now the graph better describes the text data. Above, we can see health-related bigrams such as "prostate cancer" and "pre eclampsia" are common terms in the data set.
