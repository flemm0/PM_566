...
```{r NCBI api, eval=FALSE, include=FALSE}
# get list of PubMed Ids for sars-cov-2 trial vaccine articles
query_ids <- GET(
...
ids1 <- httr::content(query_ids) 
ids1 <- as.character(ids1)


ids1 <- stringr::str_extract_all(ids1, "<Id>[:digit:]*</Id>")[[1]] 

ids1 <- stringr::str_remove_all(ids1, "</?Id>")

ids1


# retrieve information about articles
